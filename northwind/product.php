...
?>
  ...
  <div id="categories">
    <table id="product">
      ...
      <tbody>
<?
$sql = 'select ProductID,  ProductName, UnitPrice from products where CategoryID=? and';
$sql .=' Discontinued=0';
$stmt = $conn->prepare($sql);
$stmt->bind_param('i',$_GET['category']);
try{
...
$sql = "select ProductName, Units from cart_details c join products p on c.ProductID=p.ProductID"; //ให้ขึ้นว่าเราเลือกอะไรลงตะกร้าบ้าง
